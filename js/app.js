(() => {
    ...
    function initSliders() {
        if (document.querySelector(".services__slider1")) new swiper_core_Swiper(".services__slider1", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".services__slider2")) new swiper_core_Swiper(".services__slider2", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".services__slider3")) new swiper_core_Swiper(".services__slider3", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".services__slider4")) new swiper_core_Swiper(".services__slider4", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".goal__slider")) new swiper_core_Swiper(".goal__slider", {
            ...
            navigation: {
                prevEl: ".swiper-button-prevgoal",
                nextEl: ".swiper-button-nextgoal"
            },
            on: {}
        });
        if (document.querySelector(".ideas__slider")) new swiper_core_Swiper(".ideas__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            navigation: {
                prevEl: ".swiper-button-prevideas",
                nextEl: ".swiper-button-nextideas"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".reviews__slider", {
            ...
            navigation: {
                prevEl: ".swiper-button-prevreviews",
                nextEl: ".swiper-button-nextreviews"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
